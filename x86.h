...
static inline void x86_cpuid(uint32_t leaf, uint32_t /* out */ *eax,
                             uint32_t /* out */ *ebx, uint32_t /* out */ *ecx,
                             uint32_t /* out */ *edx)
{
...
static inline void x86_cpuid_c(uint32_t leaf, uint32_t csel,
                               uint32_t /* out */ *eax, uint32_t /* out */ *ebx,
...
{
    __asm__ volatile("movq %0, %%fs:%1" ::"ir"(val), "m"(*(uint64_t *)(offset))
                     : "memory");
}
...
{
    __asm__ volatile("movq %0, %%gs:%1" ::"ir"(val), "m"(*(uint64_t *)(offset))
                     : "memory");
}
